...
\section{CMake pour un projet complexe}
\subsection{}

\begin{frame}[fragile]{Utilisation de CMake}

  \begin{block}{Cloner le dép\^ot suivant}
    \url{https://gitlab.com/lbaudouin/empty_library.git}
  \end{block}

  \begin{exampleblock}{Objectif}
    Générer le fichier \textit{CMakeLists.txt} pour le projet
  \end{exampleblock}
